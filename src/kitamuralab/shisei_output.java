	...
	public void paintComponent(Graphics g) {
		...
		try {
			...
			while(node.get("people").get(k)!=null) {
				...
				if(born_x[k][9]!=0 && born_x[k][10]!=0) 
					{
					g2.draw(new Line2D.Double(born_x[k][9]/xy,born_y[k][9]/xy,born_x[k][10]/xy,born_y[k][10]/xy));
					}
				if(born_x[k][10]!=0 && born_x[k][11]!=0) 
					{
					g2.setColor(Color.black);
					g2.draw(new Line2D.Double(born_x[k][10]/xy,born_y[k][10]/xy,born_x[k][11]/xy,born_y[k][11]/xy));
					}
				if(born_x[k][12]!=0 && born_x[k][13]!=0) 
					{
					g2.draw(new Line2D.Double(born_x[k][12]/xy,born_y[k][12]/xy,born_x[k][13]/xy,born_y[k][13]/xy));
					}
				if(born_x[k][13]!=0 && born_x[k][14]!=0) 
					{
					g2.draw(new Line2D.Double(born_x[k][13]/xy,born_y[k][13]/xy,born_x[k][14]/xy,born_y[k][14]/xy));
					}
				if(born_x[k][0]!=0 && born_x[k][15]!=0) 
					{
					g2.draw(new Line2D.Double(born_x[k][0]/xy,born_y[k][0]/xy,born_x[k][15]/xy,born_y[k][15]/xy));
					}
				if(born_x[k][0]!=0 && born_x[k][16]!=0) 
					{
					g2.draw(new Line2D.Double(born_x[k][0]/xy,born_y[k][0]/xy,born_x[k][16]/xy,born_y[k][16]/xy));
					}
				if(born_x[k][15]!=0 && born_x[k][17]!=0)
					{
					g2.draw(new Line2D.Double(born_x[k][15]/xy,born_y[k][15]/xy,born_x[k][17]/xy,born_y[k][17]/xy));
					}
				if(born_x[k][16]!=0 && born_x[k][18]!=0) 
					{
					g2.draw(new Line2D.Double(born_x[k][16]/xy,born_y[k][16]/xy,born_x[k][18]/xy,born_y[k][18]/xy));
					}
				if(born_x[k][0]!=0 && born_x[k][15]!=0) 
					{
					g2.draw(new Line2D.Double(born_x[k][0]/xy,born_y[k][0]/xy,born_x[k][15]/xy,born_y[k][15]/xy));
					}
				if(born_x[k][14]!=0 && born_x[k][19]!=0) 
					{
					g2.setColor(Color.blue);
					g2.draw(new Line2D.Double(born_x[k][14]/xy,born_y[k][14]/xy,born_x[k][19]/xy,born_y[k][19]/xy));
					}//19が左足つま先
				if(born_x[k][19]!=0 && born_x[k][20]!=0)
					{
					g2.draw(new Line2D.Double(born_x[k][19]/xy,born_y[k][19]/xy,born_x[k][20]/xy,born_y[k][20]/xy));
					}
				if(born_x[k][14]!=0 && born_x[k][21]!=0) 
					{
					g2.setColor(Color.red);
					g2.draw(new Line2D.Double(born_x[k][14]/xy,born_y[k][14]/xy,born_x[k][21]/xy,born_y[k][21]/xy));
					}//21が左足かかと
				if(born_x[k][11]!=0 && born_x[k][23]!=0) 
					{
					g2.setColor(Color.black);
					g2.draw(new Line2D.Double(born_x[k][11]/xy,born_y[k][11]/xy,born_x[k][23]/xy,born_y[k][23]/xy));
					}//左足つま先、23が左足つま先座標
				if(born_x[k][11]!=0 && born_x[k][22]!=0)
					{
					g2.setColor(Color.black);
					g2.draw(new Line2D.Double(born_x[k][11]/xy,born_y[k][11]/xy,born_x[k][22]/xy,born_y[k][22]/xy));
					}//、左足かかと。22が左足かかと座標
				if(born_x[k][22]!=0 && born_x[k][24]!=0) 
					{
					g2.setColor(Color.black);
					g2.draw(new Line2D.Double(born_x[k][22]/xy,born_y[k][22]/xy,born_x[k][24]/xy,born_y[k][24]/xy));
					}
				
				
				//System.out.println("角度の出力");
				double x00 = born_x[k][0];
				double y00 = born_y[k][0];
				double x01= born_x[k][1];
				double y01 = born_y[k][1];
				double x19 = born_x[k][0];
						//born_x[k][19];
				double y19 = 0;
						//born_y[k][19];
				//double x21 = born_x[k][21];
				//double y21 = born_y[k][21];
				
				double ppp = (y01-y00)/(x01-x00);
				double q = 0;
				//(y21-y19)/(x21-x19);
				double r = y1-(((y01-y00)/(x01-x00))*x00);
				double s = 0;
				//y21-(((y21-y19)/(x21-x19))*x19);
				
				
				double xp = (r-s)/(q-ppp) ;
				double yp = ((q*r)-(ppp*s))/(q-ppp);
				...
				System.out.println(kakudo); //上半身姿勢角度
