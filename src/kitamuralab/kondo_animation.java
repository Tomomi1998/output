...
public class kondo_animation extends JPanel{
	double born_x[][] = new double[100][25]; //x座標を格納するための配列
	double born_y[][] = new double[100][25]; //y座標を格納するための配列
	//ディレクトリ指定
	File file =new File("video_json/marin_flip_1_result");
	File files[] = file.listFiles();
	ObjectMapper mapper = new ObjectMapper();
	int n=0;
	Timer timer;
	public kondo_animation() {
		setOpaque(false);
	...
	public void paintComponent(Graphics g) {
		...
		try {
			...
			while(node.get("people").get(k)!=null) {
				...
				if(born_x[k][0]!=0 && born_x[k][1]!=0) g2.draw(new Line2D.Double(born_x[k][0]/xy,born_y[k][0]/xy,born_x[k][1]/xy,born_y[k][1]/xy));
				if(born_x[k][1]!=0 && born_x[k][2]!=0) g2.draw(new Line2D.Double(born_x[k][1]/xy,born_y[k][1]/xy,born_x[k][2]/xy,born_y[k][2]/xy));
				if(born_x[k][2]!=0 && born_x[k][3]!=0) g2.draw(new Line2D.Double(born_x[k][2]/xy,born_y[k][2]/xy,born_x[k][3]/xy,born_y[k][3]/xy));
				if(born_x[k][3]!=0 && born_x[k][4]!=0) g2.draw(new Line2D.Double(born_x[k][3]/xy,born_y[k][3]/xy,born_x[k][4]/xy,born_y[k][4]/xy));
				if(born_x[k][1]!=0 && born_x[k][5]!=0) g2.draw(new Line2D.Double(born_x[k][1]/xy,born_y[k][1]/xy,born_x[k][5]/xy,born_y[k][5]/xy));
				if(born_x[k][5]!=0 && born_x[k][6]!=0) g2.draw(new Line2D.Double(born_x[k][5]/xy,born_y[k][5]/xy,born_x[k][6]/xy,born_y[k][6]/xy));
				if(born_x[k][6]!=0 && born_x[k][7]!=0) g2.draw(new Line2D.Double(born_x[k][6]/xy,born_y[k][6]/xy,born_x[k][7]/xy,born_y[k][7]/xy));
				if(born_x[k][1]!=0 && born_x[k][8]!=0) g2.draw(new Line2D.Double(born_x[k][1]/xy,born_y[k][1]/xy,born_x[k][8]/xy,born_y[k][8]/xy));
				if(born_x[k][8]!=0 && born_x[k][9]!=0) g2.draw(new Line2D.Double(born_x[k][8]/xy,born_y[k][8]/xy,born_x[k][9]/xy,born_y[k][9]/xy));
				if(born_x[k][8]!=0 && born_x[k][12]!=0) g2.draw(new Line2D.Double(born_x[k][8]/xy,born_y[k][8]/xy,born_x[k][12]/xy,born_y[k][12]/xy));
